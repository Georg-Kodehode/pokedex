// asynchronously get data from url and return a promise
...
/** mock API interface - returns a list of pokémon or a detailed object of a single pokémon */
export function getMockApi(url) {
  ...
  else if (url === "https://pokeapi.co/api/v2/pokemon/?offset=20&limit=20") {
    return {
      count: 1154,
      next: null,
